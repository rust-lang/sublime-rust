...
![Alt text](docs/img/running_tests.gif?raw=true "Running Tests with Rust Enhanced")
![Alt text](docs/img/showing_errors.gif?raw=true "Highlighting errors and warnings with Rust Enhanced")
